...
export const mockCompanyCodes: CompanyCode[] = [
  {
    ...
    authorizedEmails: ['user1@acme-corp.com', 'user2@acme-corp.com'],
    isActive: true,
    maxUsers: 50,
  ...
  },
  {
    ...
    authorizedEmails: ['developer@tech-solutions.com', 'manager@tech-solutions.com'],
    isActive: true,
    maxUsers: 25,
    expiresAt: '2025-12-31T23:59:59Z',
    createdAt: '2024-01-01T00:00:00Z',
  ...
  },
  {
    ...
    authorizedEmails: ['consultant@consulting-partners.com'],
    isActive: false,
    maxUsers: 10,
