...
export const FINNISH_TRANSLATIONS = {
  ...
  roleTrainer: 'Kouluttaja',
  roleTrainerDesc: 'Kouluttaja - seuraa opiskelijoiden edistymistä ja vastauksia',
  roleTrainee: 'Koulutettava',
  roleTraineeDesc: 'Koulutettava - näe oma edistymisesi ja saatu palaute',
...
export const ENGLISH_TRANSLATIONS = {
  ...
  roleTrainer: 'Trainer',
  roleTrainerDesc: 'Trainer - monitor student progress and answers',
  roleTrainee: 'Trainee',
  roleTraineeDesc: 'Trainee - view your progress and feedback',
  roleAdmin: 'Admin',
